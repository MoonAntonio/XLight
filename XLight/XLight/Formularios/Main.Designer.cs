namespace XLight
{
	partial class Main
	{
        ...
        gradient39,
        gradient40};
			this.BtnHistorial.DisabledGradient = gradient40;
			this.BtnHistorial.EnabledGradient = gradient37;
			...
			this.BtnHistorial.HoverGradient = gradient38;
			...
			this.BtnHistorial.Image.Border = border10;
			...
			this.BtnHistorial.PressedGradient = gradient39;
        ...
        gradient43,
        gradient44};
			this.BtnClientes.DisabledGradient = gradient44;
			this.BtnClientes.EnabledGradient = gradient41;
			...
			this.BtnClientes.HoverGradient = gradient42;
			...
			this.BtnClientes.Image.Border = border11;
			...
			this.BtnClientes.PressedGradient = gradient43;
        ...
        gradient3,
        gradient4};
			this.BtnOpciones.DisabledGradient = gradient4;
			this.BtnOpciones.EnabledGradient = gradient1;
			...
			this.BtnOpciones.HoverGradient = gradient2;
			...
			this.BtnOpciones.Image.Border = border1;
			...
			this.BtnOpciones.PressedGradient = gradient3;
        ...
        gradient7,
        gradient8};
			this.BtnSalir.DisabledGradient = gradient8;
			this.BtnSalir.EnabledGradient = gradient5;
			...
			this.BtnSalir.HoverGradient = gradient6;
			...
			this.BtnSalir.Image.Border = border2;
			...
			this.BtnSalir.PressedGradient = gradient7;
        ...
        gradient11,
        gradient12};
			this.BtnMaximizar.DisabledGradient = gradient12;
			this.BtnMaximizar.EnabledGradient = gradient9;
			this.BtnMaximizar.ForeColorDisabled = System.Drawing.Color.FromArgb(((int)(((byte)(131)))), ((int)(((byte)(129)))), ((int)(((byte)(129)))));
			this.BtnMaximizar.HoverGradient = gradient10;
			...
			this.BtnMaximizar.Image.Border = border3;
			...
			this.BtnMaximizar.PressedGradient = gradient11;
        ...
        gradient15,
        gradient16};
			this.BtnMinimizar.DisabledGradient = gradient16;
			this.BtnMinimizar.EnabledGradient = gradient13;
			this.BtnMinimizar.ForeColorDisabled = System.Drawing.Color.FromArgb(((int)(((byte)(131)))), ((int)(((byte)(129)))), ((int)(((byte)(129)))));
			this.BtnMinimizar.HoverGradient = gradient14;
			...
			this.BtnMinimizar.Image.Border = border4;
			...
			this.BtnMinimizar.PressedGradient = gradient15;
        ...
        1F};
			...
			this.BoxHistorial.Controls.Add(this.BoxOpciones);
        ...
        1F};
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.BoxOpciones.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(238)))), ((int)(((byte)(238)))), ((int)(((byte)(238)))));
        ...
        gradient19,
        gradient20};
			this.BtnLimpiarHistorial.DisabledGradient = gradient20;
			this.BtnLimpiarHistorial.EnabledGradient = gradient17;
			...
			this.BtnLimpiarHistorial.HoverGradient = gradient18;
			...
			this.BtnLimpiarHistorial.Image.Border = border5;
			...
			this.BtnLimpiarHistorial.PressedGradient = gradient19;
        ...
        gradient23,
        gradient24};
			this.BtnRutaCllientes.DisabledGradient = gradient24;
			this.BtnRutaCllientes.EnabledGradient = gradient21;
			...
			this.BtnRutaCllientes.HoverGradient = gradient22;
			...
			this.BtnRutaCllientes.Image.Border = border6;
			...
			this.BtnRutaCllientes.PressedGradient = gradient23;
        ...
        gradient27,
        gradient28};
			this.BtnRutaHistorial.DisabledGradient = gradient28;
			this.BtnRutaHistorial.EnabledGradient = gradient25;
			...
			this.BtnRutaHistorial.HoverGradient = gradient26;
			...
			this.BtnRutaHistorial.Image.Border = border7;
			...
			this.BtnRutaHistorial.PressedGradient = gradient27;
        ...
        gradient31,
        gradient32};
			this.BtnRutaData.DisabledGradient = gradient32;
			this.BtnRutaData.EnabledGradient = gradient29;
			...
			this.BtnRutaData.HoverGradient = gradient30;
			...
			this.BtnRutaData.Image.Border = border8;
			...
			this.BtnRutaData.PressedGradient = gradient31;
